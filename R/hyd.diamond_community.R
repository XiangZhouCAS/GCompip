...
#' @param hyd_db Please set the directory of hydrogenases' diamond database (e.g.'hyddb.all.dmnd').
...
#' @export
#'
#' @examples hyd.diamond_GAM(input_reads = "your/reads/data/sample_1.fastq",result = "sample_1",threads = 40,hyd_db = "your/database/hyddb.all.dmnd",USCG_db = "your/database/Ribo_14.dmnd",script = "your/database/hyd_id-name.script",min_length = 75)
hyd.diamond_GAM <- function(input_reads,result,threads = 1,
                            hyd_db,script,
                            USCG_db,skip_fastp = F,
                            min_length = 50,
