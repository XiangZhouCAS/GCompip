...
#' @param ter_db Please set the directory of terminal genes' diamond database (e.g.'ter.dmnd').
...
#' @export
#'
#' @examples ter.diamond_GAM(input_reads = "your/reads/data/sample_1.fastq",result = "sample_1",threads = 40,ter_db = "your/database/ter.dmnd",USCG_db = "your/database/Ribo_14.dmnd",min_length = 75)
ter.diamond_GAM <- function(input_reads,result,threads = 1,
                            ter_db,USCG_db,
                            skip_fastp = F,
