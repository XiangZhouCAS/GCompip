...
#' @export
#'
#' @examples diamond_community(input_reads = "your/reads/data/sample_1.fastq",result = "sample_1",threads = 40,diamond_db = "your/database/ter_hydB-aprA.dmnd",USCG_db = "your/database/Ribo_14.dmnd",min_length = 75,filter_condition = "default")
diamond_GAM <- function(input_reads,result,threads = 1,
                              SCG_db,USCG_db,skip_fastp = F,
